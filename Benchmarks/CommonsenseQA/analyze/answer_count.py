...
if __name__ == "__main__":
    INPUT_DIR = "/data3/jykim/Projects/CCQA_official/Benchmarks/CommonsenseQA/Results/ccqa_result/t5_0_results"
    OUTPUT_DIR = "/data3/jykim/Projects/CCQA_official/Benchmarks/CommonsenseQA/analyze/answer_count"
