...
def plot_stats(csv_file):
    ...
    for bar, total, correct in zip(bars, df["Total"], df["Correct"]):
        ...
        plt.text(bar.get_x() + bar.get_width()/2, height + 0.02, f"{correct}/{total}", ha='center', fontsize=9)
...
if __name__ == "__main__":
    INPUT_DIR = "/data3/jykim/Projects/CCQA_official/Benchmarks/MAWPS/Result/ccqa_result"
    OUTPUT_DIR = "/data3/jykim/Projects/CCQA_official/Benchmarks/MAWPS/Analayze/answer_count"
